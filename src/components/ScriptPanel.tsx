...
export default function ScriptPanel() {
  ...
  const [userScriptQuestion, setUserScriptQuestion] = useState('');
  ...
  const handleGenerate = async () => {
    ...
    try {
      const payload = {
        ...
        user_question: userScriptQuestion,
      };
      ...
      <div className="flex-1 overflow-y-auto space-y-4 pr-1">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm">
          ...
          <p className="text-xs text-gray-500 mb-3">
            描述你在话术上遇到的困难，AI会针对性优化
          </p>
          <textarea
            value={userScriptQuestion}
            onChange={(e) => setUserScriptQuestion(e.target.value)}
            placeholder="例如：
• 用户说太贵了，不知道怎么回复
• 开场留不住人，3秒就划走了
• 促单环节没力度，转化很低
